...
_INTENT_PATTERNS: list[tuple[str, list[str]]] = [
    ...
    ("lead", [
        r"\binterested\b", r"\bwant to (buy|install|get|enquire|know more)\b", r"\binterested in\b"
        r"\bquote\b", r"\bsite assessment\b", r"\bbook (a |an |)(appointment|visit|call)\b",r"\bquotation\b"
        r"\bsign up\b", r"\bget in touch\b", r"\bcontact (me|us)\b", r"\bassessment\b"
        r"\binstall (solar|charger|ev)\b", r"\bbuy\b",r"\binstall\b"
